...
public:
    ...
    virtual std::unique_ptr<AIBomber> createAIBomber(float x, float y, AIBomberType type) = 0;
    ...
    virtual std::unique_ptr<KnockedOutBomber> createKnockedOutBomber(float x, float y) = 0;
};
